# 요약
bytecode 는 vm 에서 실행할 수 있는 instruction 의 선형 나열 이다. bytecode 는 machine code 를 흉내낸다.
...
Remember that whole family of AST classes we defined in jlox? In clox, we’ve reduced that down to three arrays: 
...
- That doesn’t work well for large or variable-sized constants like strings. 
